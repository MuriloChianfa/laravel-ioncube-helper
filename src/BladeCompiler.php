    ...
    public function compile($path = null)
    {
        ...
        if (! is_null($this->cachePath)) {
            if (function_exists('ioncube_read_file')) {
                ...
                // 7 - An encrypted file cannot be read by an non-encoded PHP script.
                // 8 - The wrong passphrase was specified, or the wrong Encoder installation was used to encrypt the file.
                // 9 - ioncube_write_file() must be called from an encoded file to produce an encrypted file without a custom passphrase.
            } else {
